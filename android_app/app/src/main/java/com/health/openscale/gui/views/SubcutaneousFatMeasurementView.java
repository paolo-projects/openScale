...
public class SubcutaneousFatMeasurementView extends FloatMeasurementView {
    // Don't change key value, it may be stored persistent in preferences
    public static final String KEY = "subfat";

    public SubcutaneousFatMeasurementView(Context context) {
        super(context, R.string.subfat_title, R.drawable.ic_fat);
    }
    ...
    protected float getMeasurementValue(ScaleMeasurement measurement) {
        return measurement.getSubFat();
    }

    @Override
    protected void setMeasurementValue(float value, ScaleMeasurement measurement) {
        measurement.setSubFat(value);
    }
    ...
    @Override
    public int getColor() {
        return Color.parseColor("#ff8b33");
    }
