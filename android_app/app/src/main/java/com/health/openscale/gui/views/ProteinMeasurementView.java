...
public class ProteinMeasurementView extends FloatMeasurementView {
    // Don't change key value, it may be stored persistent in preferences
    public static final String KEY = "protein";

    public ProteinMeasurementView(Context context) {
        super(context, R.string.protein_title, R.drawable.ic_lbm);
    }
    ...
    protected float getMeasurementValue(ScaleMeasurement measurement) {
        return measurement.getProtein();
    }

    @Override
    protected void setMeasurementValue(float value, ScaleMeasurement measurement) {
        measurement.setProtein(value);
    }
